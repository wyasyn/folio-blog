...
export default function page() {
  ...
  return (
    <main className="w-[95%] max-w-[990px] bg-secondary p-8 lg:p-12 prose dark:prose-invert rounded-lg mx-auto border my-8 lg:my-14 prose-h1:tracking-wide prose-h2:tracking-wide prose-h3:tracking-wide prose-h4:tracking-wider prose-h5:tracking-wider">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Yasin Walum.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Yasin Walum, accessible from{" "}
            <Link
              href={`${baseUrl}`}
